...
def predict(
    ...
    for batch in tqdm(data_loader, disable=disable_progress_bar, leave=False):
        ...
        if model.is_atom_bond_targets:
            ...
            if model.loss_function in ["mve", "beta_nll","stochastic"]: # TODO split
            ...
            if scaler is not None:
                ...
                if model.loss_function in ["mve", "beta_nll","stochastic"]: # TODO unscale variance
            ...
            if model.loss_function in ["mve", "beta_nll","stochastic"]: # TODO extend var
    ...
    if return_unc_parameters:
        if model.loss_function in ["mve", "beta_nll","stochastic"]: # TODO return unc
            return preds, var
        elif model.loss_function == "dirichlet":
            return preds, alphas
        elif model.loss_function == "evidential":
