...
def forward_vle(
        ...
        output: torch.Tensor,
        wohl_order: int = None,
        fugacity_balance: str = None,
        temperature: torch.Tensor = None,
        x_1: torch.Tensor = None,
        x_2: torch.Tensor = None,
        q_1: torch.Tensor = None,
        q_2: torch.Tensor = None,
        log10p1sat: torch.Tensor = None,
        log10p2sat: torch.Tensor = None,
):
    if vle == "basic": # don't need to calculate gamma for basic, everything else needs to predict gamma
